...
def new_files_to_load(wiki_file,kaggle_file,ratings):
    ...
    print('--------------------------------------------')
    print('Started Extract Transform and Load Operation')
    # dd/mm/YY H:M:S
    ...
    ####################################
    ## Step 1: Cleaning Wikipedia data #
    ####################################
    print('*****')
    print('1.0 Started Cleaning Wikipedia Data')
    ...
    print('  1.1 Created Wiki Movies') 
    
    # Create a DataFrame for movies
    wiki_movies_df = pd.DataFrame(wiki_movies)
    print('  1.2 Converted Wiki Movies to Dataframe') 
    ...
    print('  1.3 Cleaned Wiki Movies Dataframe')
    ...
    print('  1.4 Updated Wiki Movies Dataframe')   
    ...
    print('DONE CLEANING WIKIPEDIA DATA')

    ################################
    ##Step 2: Cleaning Kaggle data #
    ################################
    print('*****')
    print('2.0 Started Cleaning Kaggle Data')
    ...
    print('DONE CLEANING KAGGLE DATA') 
    
    ###########################################
    ##Step3: Merge Wikipedia and Kaggle Data  #
    ###########################################
    print('*****')
    print('3.0 Started Merging Wikipedia and Kaggle Data')
    ...
    print('DONE MERGING WIKIPEDIA AND KAGGLE DATA')     

    ############################################    
    ##Step 4: Transform and merge ratings data #
    ############################################
    print('*****')
    print('4.0 Started Transforming and Merging Ratings Data')    
    ...
    print('DONE TRANSFORMING AND MERGING RATINGS DATA')    
    
    ###############################################    
    #Step 5: Load and update data into SQL tables #
    ###############################################
    print('*****')
    print("5.0 Deleting Old SQL Data, please wait!")
    ...
    print("  5.1 Movies Records Deleted")    
    ...
    print("  5.2 Ratings records deleted")   
 
    print("6.0 Starting Import of New Data (Get coffee, this will take a while!)")
    ...
    print('*****')
    print('---------------------------------------------------')
    print('ETL PROCESS COMPLETED--THANK YOU FOR YOUR PATIENCE!')
